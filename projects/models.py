...
class Project(models.Model):
    ...
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name="автор проекта", on_delete=models.CASCADE, related_name="owned_projects")
    ...
    status = models.CharField(verbose_name="статус проекта", max_length=6, choices=STATUS_CHOICES, default="open")
    participants = models.ManyToManyField(settings.AUTH_USER_MODEL, verbose_name="участники проекта", blank=True, related_name="participated_projects")
